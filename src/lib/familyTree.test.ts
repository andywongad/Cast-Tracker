...
import { layoutTree, type LayoutLink } from './familyTree/layout';
...
/**
 * The arrangement. The board is six columns and unbounded rows, so families stack as bands rather
 * than sitting side by side the way a printed tree does — the constraint is real and the tests
 * below encode what falls out of it.
 *
 * The fixture is the shape the real generation returns for Game of Thrones episode one: three
 * families of different sizes plus a crowd of people who are nobody's relative.
 */
