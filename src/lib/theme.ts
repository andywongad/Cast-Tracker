...
export const THEMES: Record<ThemeName, ThemeTokens> = {
  Dark: {
    ...
    accent: '#BE95E0', accentText: '#0D0F14', accentTint: 'rgba(190,149,224,0.16)', accentSoft: '#BE95E0', initialsTint: 'rgba(255,255,255,0.55)', scrim: 'rgba(0,0,0,0.6)',
  ...
  Light: {
    ...
    accent: '#6B2D8F', accentText: '#FFFFFF', accentTint: '#F2EAF8', accentSoft: '#6B2D8F', initialsTint: 'rgba(26,26,26,0.35)', scrim: 'rgba(26,26,26,0.35)',
