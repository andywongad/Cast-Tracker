...
export default function RelationshipMap({ show, seasonCast, currentSeason, episodeOptions, mapHelpOpen, onToggleHelp }: {
  ...
  /** One line of feedback after an action that rearranges the board. */
   ...
   * is why it only ever runs from an explicit action. `resolveCells` anticipated this in its own
   * comment: a real generational tidy-up is a separate thing from placing newcomers, and this is
   * it.
   */
  ...
  const tidyTree = () => {
    ...
    setBoardNote('Arranged by generation \u2014 drag anyone you\u2019d rather have elsewhere.');
  };
